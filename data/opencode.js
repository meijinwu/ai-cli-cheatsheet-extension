...
window.CHEATSHEET_DATA["opencode"] = {
  ...
  items: [
    ...
    {id:"opencode-init", cat:"slash", cmd:"/init", en:"Create/update AGENTS.md", zh:"引导创建或更新项目的 AGENTS.md 文件"},
    ...
    {id:"opencode-share", cat:"slash", cmd:"/share", en:"Share current session", zh:"生成可分享的会话链接"},
    ...
    {id:"opencode-help", cat:"slash", cmd:"/help", en:"Show help dialog", zh:"显示帮助对话框"},
    {cat:"slash", cmd:"/exit", en:"Exit OpenCode", zh:"退出 OpenCode（别名 /quit /q）"},

    // ===== CLI 命令与启动参数 =====
    {id:"opencode-launch", cat:"flag", cmd:"opencode", en:"Start TUI in current directory", zh:"在当前目录启动交互式终端界面"},
    ...
    {id:"opencode-run-continue", cat:"flag", cmd:"opencode run -c", en:"Continue last session", zh:"在非交互模式下继续上次会话（--continue）"},
    ...
    {id:"opencode-serve", cat:"flag", cmd:"opencode serve", en:"Start headless API server", zh:"启动无界面 HTTP API 服务器，供外部程序调用"},
    ...
    {id:"opencode-models", cat:"flag", cmd:"opencode models", en:"List all models", zh:"列出所有已配置提供商的可用模型"},
    {cat:"flag", cmd:"opencode models --refresh", en:"Refresh models cache", zh:"从 models.dev 刷新模型列表缓存"},
    {id:"opencode-auth-login", cat:"flag", cmd:"opencode auth login", en:"Add provider credentials", zh:"交互式添加 AI 提供商的 API Key"},
    ...
    {id:"opencode-session-list", cat:"flag", cmd:"opencode session list", en:"List all sessions", zh:"列出所有历史会话"},
    ...
    {id:"opencode-model-flag", cat:"flag", cmd:"--model / -m [provider/model]", en:"Specify model", zh:"启动时指定使用的模型（格式：provider/model）"},
