...
window.CHEATSHEET_DATA["antigravity-cli"] = {
  ...
  items: [
    ...
    {id:"agy-help", cat:"flag", cmd:"agy help", en:"Show wrapper commands", zh:"显示外层shell命令（区别于会话内的斜杠命令）"},
    {id:"agy-update", cat:"flag", cmd:"agy install / agy update", en:"Install or update agy", zh:"安装或更新 agy 本体"},
    ...
    {id:"agy-config", cat:"slash", cmd:"/config 或 /settings", en:"Open configuration", zh:"打开配置设置（对应 Gemini CLI 的 /settings）"},
    ...
    {id:"agy-fork", cat:"slash", cmd:"/fork", en:"Explore alt approach", zh:"分叉当前对话，探索不同方案而不丢失当前线程（Gemini CLI无直接对应）"},
    {cat:"slash", cmd:"/resume", en:"Reopen previous logs", zh:"恢复之前的会话记录；关闭时会打印恢复指定会话所需的命令"},
    {id:"agy-agents", cat:"slash", cmd:"/agents", en:"Open Agent Manager panel", zh:"打开代理管理面板，查看活跃和已完成的后台子代理状态、所在步骤"},
    ...
    {id:"agy-mcp", cat:"slash", cmd:"/mcp", en:"Manage MCP servers", zh:"管理Model Context Protocol服务"},
    ...
    {id:"agy-artifacts", cat:"slash", cmd:"/artifacts", en:"Manage implementation plan", zh:"管理实施计划（对应Gemini CLI的/plan）"},
    ...
    {id:"agy-usage", cat:"slash", cmd:"/usage", en:"Offline developer manual", zh:"离线开发手册（Gemini CLI无直接对应）"},
