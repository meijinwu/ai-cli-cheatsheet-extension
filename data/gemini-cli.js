...
window.CHEATSHEET_DATA["gemini-cli"] = {
  ...
  items: [
    ...
    {id:"gemini-chat", cat:"slash", cmd:"/chat（/resume别名）", en:"Session browser & checkpoints", zh:"浏览历史会话和手动检查点（功能同/resume）"},
    {id:"gemini-clear", cat:"slash", cmd:"/clear", en:"Clear terminal screen", zh:"清空终端屏幕和可见历史（快捷键 Ctrl+L）"},
    ...
    {id:"gemini-copy", cat:"slash", cmd:"/copy", en:"Copy last output", zh:"复制最近一次输出到剪贴板（需要系统剪贴板工具）"},
    ...
    {id:"gemini-editor", cat:"slash", cmd:"/editor", en:"Select supported editor", zh:"打开对话框选择支持的编辑器"},
    ...
    {id:"gemini-init", cat:"slash", cmd:"/init", en:"Generate GEMINI.md", zh:"分析当前目录生成定制化的项目说明文件"},
    ...
    {id:"gemini-restore", cat:"slash", cmd:"/restore [tool_call_id]", en:"Restore files before a tool ran", zh:"把项目文件恢复到某次工具执行前的状态"},
    {id:"gemini-rewind", cat:"slash", cmd:"/rewind", en:"Navigate back through history", zh:"回溯对话历史，可选回退聊天和/或代码改动（快捷键Esc Esc）"},
    ...
    {id:"gemini-theme", cat:"slash", cmd:"/theme", en:"Change visual theme", zh:"切换界面视觉主题"},
    ...
    {id:"gemini-vim", cat:"slash", cmd:"/vim", en:"Toggle vim mode", zh:"切换Vim风格的导航和编辑模式"},
